 ...
 * Low-res 0.25 scale buffer with disabled antialiasing.
 * Explicit width/height added to SVGs to resolve iOS Safari blank texture issue.
 */
...
// SVG assets with explicit width and height attributes for iOS Safari texture sizing
const skySvg = `
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600" width="800" height="600">
    <rect width="800" height="600" fill="#0f172a" />
    <line x1="0" y1="150" x2="800" y2="150" stroke="#1e293b" stroke-width="2" />
    <line x1="0" y1="300" x2="800" y2="300" stroke="#1e293b" stroke-width="2" />
    <line x1="0" y1="450" x2="800" y2="450" stroke="#1e293b" stroke-width="2" />
    <line x1="200" y1="0" x2="200" y2="600" stroke="#1e293b" stroke-width="2" />
    <line x1="400" y1="0" x2="400" y2="600" stroke="#1e293b" stroke-width="2" />
    <line x1="600" y1="0" x2="600" y2="600" stroke="#1e293b" stroke-width="2" />
</svg>`;

const dialSvg = `
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 160" width="160" height="160">
    <circle cx="80" cy="80" r="70" fill="none" stroke="#202838" stroke-width="3" stroke-dasharray="8,8" />
    <circle cx="80" cy="80" r="30" fill="none" stroke="#ff6b00" stroke-width="4" />
    <line x1="80" y1="10" x2="80" y2="150" stroke="rgba(96, 116, 139, 0.2)" stroke-width="1.5" />
    <line x1="10" y1="80" x2="150" y2="80" stroke="rgba(96, 116, 139, 0.2)" stroke-width="1.5" />
</svg>`;

const mountainBackSvg = `
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600" width="800" height="600">
    <path d="M -50 480 L 180 340 L 320 490 L 460 310 L 680 520 L 850 440 L 850 600 L -50 600 Z" fill="#1e293b"/>
    <path d="M -50 480 L 180 340 L 320 490 L 460 310 L 680 520 L 850 440" fill="none" stroke="#475569" stroke-width="3"/>
</svg>`;

const mountainMidSvg = `
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600" width="800" height="600">
    <path d="M -50 520 L 240 410 L 430 530 L 580 400 L 850 540 L 850 600 L -50 600 Z" fill="#0f172a"/>
    <path d="M -50 520 L 240 410 L 430 530 L 580 400 L 850 540" fill="none" stroke="#64748b" stroke-width="3"/>
</svg>`;

const foregroundSvg = `
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600" width="800" height="600">
    <path d="M -50 540 C 150 540, 250 510, 450 550 C 650 590, 750 530, 850 555 L 850 600 L -50 600 Z" fill="#020617" stroke="#ff6b00" stroke-width="5"/>
    <line x1="50" y1="542" x2="50" y2="560" stroke="#475569" stroke-width="3" />
    <line x1="150" y1="540" x2="150" y2="560" stroke="#475569" stroke-width="3" />
    <line x1="250" y1="535" x2="250" y2="560" stroke="#475569" stroke-width="3" />
    <line x1="350" y1="540" x2="350" y2="560" stroke="#475569" stroke-width="3" />
    <line x1="450" y1="550" x2="450" y2="570" stroke="#ff6b00" stroke-width="4" />
    <line x1="550" y1="560" x2="550" y2="580" stroke="#475569" stroke-width="3" />
    <line x1="650" y1="560" x2="650" y2="580" stroke="#475569" stroke-width="3" />
    <line x1="750" y1="555" x2="750" y2="580" stroke="#475569" stroke-width="3" />
</svg>`;
...
function createSvgTexture(svgString) {
    ...
    texture.minFilter = THREE.NearestFilter; // Nearest filter for crisp pixel lines
...
export function initParallax() {
    ...
    // 4. Create planes with nearest-neighbor SVG textures
    ...
    dialMesh.position.set(0, 0.8, -2.5);
    scene.add(dialMesh);
